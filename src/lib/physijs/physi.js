module.exports = function (THREE) {
	...
	const physiJSWorkerW3 = require("./physijs.worker");
	...
	Physijs.Scene = function (params) {
		...
		// this._worker = new Worker(physiJSWorker);
		this._worker = new Worker(physiJSWorkerW3);
		...
		params = params || {};
		params.ammo = document.location.protocol + "//" + document.location.host + window.location.pathname;
