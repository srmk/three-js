...
const workercode = () => {
    ...
    switch (description.type) {
      case "plane":
        ...
        if ((shape = getShapeFromCache(cache_key)) === null) {
          ...
          shape = new AmmoRef.btStaticPlaneShape(_vec3_1, 0);
      ...
      case "box":
        ...
        if ((shape = getShapeFromCache(cache_key)) === null) {
          ...
          shape = new AmmoRef.btBoxShape(_vec3_1);
          setShapeCache(cache_key, shape);
        }
        break;
      ...
      case "sphere":
        ...
        if ((shape = getShapeFromCache(cache_key)) === null) {
          shape = new AmmoRef.btSphereShape(description.radius);
          setShapeCache(cache_key, shape);
        }
        break;
      ...
      case "cylinder":
        ...
        if ((shape = getShapeFromCache(cache_key)) === null) {
          ...
          _vec3_1.setY(description.height / 2);
          _vec3_1.setZ(description.depth / 2);
          shape = new AmmoRef.btCylinderShape(_vec3_1);
          setShapeCache(cache_key, shape);
        }
        break;
      ...
      case "capsule":
        ...
        if ((shape = getShapeFromCache(cache_key)) === null) {
          ...
          shape = new AmmoRef.btCapsuleShape(
            description.radius,
      ...
      case "cone":
        ...
        if ((shape = getShapeFromCache(cache_key)) === null) {
          shape = new AmmoRef.btConeShape(description.radius, description.height);
          setShapeCache(cache_key, shape);
        }
        break;
      ...
      case "concave":
        var i,
          triangle,
          triangle_mesh = new AmmoRef.btTriangleMesh();
        ...
        shape = new AmmoRef.btBvhTriangleMeshShape(triangle_mesh, true, true);
      ...
      case "convex":
        var i,
          point,
          shape = new AmmoRef.btConvexHullShape();
      ...
      case "heightfield":
        ...
        //   AmmoRef.setValue(ptr + f, description.points[f], "float");
        // }

        shape = new AmmoRef.btHeightfieldTerrainShape(
          description.xpts,
          description.ypts,
          ptr,
          1,
  ...
  public_functions.init = function(params) {
    ...
    //   importScripts( params.ammo + "/vendor/kq_ammo/ammo.js" );
    // } else {
    //   importScripts( params.ammo + window.location.pathname + "vendor/kq_ammo/ammo.js" );
    // }
    ...
    _transform = new AmmoRef.btTransform();
    _vec3_1 = new AmmoRef.btVector3(0, 0, 0);
    _vec3_2 = new AmmoRef.btVector3(0, 0, 0);
    _vec3_3 = new AmmoRef.btVector3(0, 0, 0);
    _quat = new AmmoRef.btQuaternion(0, 0, 0, 0);
    ...
    var collisionConfiguration = new AmmoRef.btDefaultCollisionConfiguration(),
      dispatcher = new AmmoRef.btCollisionDispatcher(collisionConfiguration),
      solver = new AmmoRef.btSequentialImpulseConstraintSolver(),
      broadphase;
    ...
    switch (params.broadphase.type) {
      case "sweepprune":
        ...
        broadphase = new AmmoRef.btAxisSweep3(_vec3_1, _vec3_2);

        break;

      case "dynamic":
      default:
        broadphase = new AmmoRef.btDbvtBroadphase();
        break;
    }

    world = new AmmoRef.btDiscreteDynamicsWorld(
      dispatcher,
      broadphase,
      solver,
  ...
  public_functions.addObject = function(description) {
    ...
    if (description.children) {
      var compound_shape = new AmmoRef.btCompoundShape(),
        _child;
      ...
      for (i = 0; i < description.children.length; i++) {
        ...
        var trans = new AmmoRef.btTransform();
        trans.setIdentity();
    ...
    motionState = new AmmoRef.btDefaultMotionState(_transform); // #TODO: btDefaultMotionState supports center of mass offset as second argument - implement
    rbInfo = new AmmoRef.btRigidBodyConstructionInfo(
      description.mass,
      motionState,
      shape,
      _vec3_1
    ...
    body = new AmmoRef.btRigidBody(rbInfo);
    AmmoRef.destroy(rbInfo);
  ...
  public_functions.addVehicle = function(description) {
    var vehicle_tuning = new AmmoRef.btVehicleTuning(),
      vehicle;
    ...
    vehicle = new AmmoRef.btRaycastVehicle(
      vehicle_tuning,
      _objects[description.rigidBody],
      new AmmoRef.btDefaultVehicleRaycaster(world)
    );
  ...
  public_functions.addWheel = function(description) {
    if (_vehicles[description.id] !== undefined) {
      ...
      if (description.tuning !== undefined) {
        tuning = new AmmoRef.btVehicleTuning();
  ...
  public_functions.removeObject = function(details) {
    ...
    AmmoRef.destroy(_objects[details.id]);
    AmmoRef.destroy(_motion_states[details.id]);
    if (_compound_shapes[details.id])
      AmmoRef.destroy(_compound_shapes[details.id]);
    if (_noncached_shapes[details.id])
      AmmoRef.destroy(_noncached_shapes[details.id]);
    var ptr =
    ...
    switch (details.type) {
      case "point":
        if (details.objectb === undefined) {
          ...
          constraint = new AmmoRef.btPoint2PointConstraint(
      ...
      case "hinge":
        if (details.objectb === undefined) {
          ...
          constraint = new AmmoRef.btHingeConstraint(
            _objects[details.objecta],
            _vec3_1,
            _vec3_2
          );
      ...
      case "slider":
        ...
        transforma = new AmmoRef.btTransform();
        ...
        if (details.objectb) {
          transformb = new AmmoRef.btTransform();
          ...
          constraint = new AmmoRef.btSliderConstraint(
            _objects[details.objecta],
            _objects[details.objectb],
            transforma,
            transformb,
        ...
        AmmoRef.destroy(transforma);
        if (transformb != undefined) {
          AmmoRef.destroy(transformb);
        }
        break;
      ...
      case "conetwist":
        ...
        constraint = new AmmoRef.btConeTwistConstraint(
          _objects[details.objecta],
          _objects[details.objectb],
          transforma,
          transformb
      ...
      case "dof":
        ...
        if (details.objectb) {
          ...
          constraint = new AmmoRef.btGeneric6DofConstraint(
            _objects[details.objecta],
            _objects[details.objectb],
            transforma,
            transformb
  ...
  reportConstraints = function() {
    ...
    self.onmessage = function(e) {
      if (e.data instanceof Float32Array) {
        ...
        switch (e.data[0]) {
          case MESSAGE_TYPES.WORLDREPORT:
            worldreport = new Float32Array(e.data);
            break;
  
          case MESSAGE_TYPES.COLLISIONREPORT:
            collisionreport = new Float32Array(e.data);
            break;
  
          case MESSAGE_TYPES.VEHICLEREPORT:
            vehiclereport = new Float32Array(e.data);
            break;
  
          case MESSAGE_TYPES.CONSTRAINTREPORT:
            constraintreport = new Float32Array(e.data);
            break;
        }
      ...
      if (e.data.cmd && public_functions[e.data.cmd]) {
        //if ( e.data.params.id !== undefined && _objects[e.data.params.id] === undefined && e.data.cmd !== 'addObject' && e.data.cmd !== 'registerMaterial' ) return;
        public_functions[e.data.cmd](e.data.params);
      }
    };
  };
